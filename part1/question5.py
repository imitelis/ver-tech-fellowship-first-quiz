...
CREATE TABLE favorite_foods (food_id INT, name VARCHAR(0, 60), vegetarian BOOLEAN)
...
SELECT animals.name AS pet_name, favorite_foods.name AS food_name FROM animals INNER JOIN favorite_foods ON animals.favorite_food_id = favorite_foods.food_id WHERE favorite_foods.vegetarian = TRUE;
